...
<body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="background:#66CCFF">
        <div class="container" >
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php" style="color:#FFFFFF">Online Unity</a>
	...
	<li class="dropdown">
        ...
        <ul class="dropdown-menu">
          ...
          <li><a href="index.php?info=login">Member</a></li>
...
<!-- slider -->			
    ...
    <div class="container">
        ...
        <div class="row">
			...
			<div class="col-sm-10" style="margin-top:60px;margin-bottom:80px">
				<h2>About </h2>
				we are one family in our society.
	...
	<div class="navbar-fixed-bottom nav navbar-inverse text-center" style="padding:15px;height:40px; background:#66CCFF">
		<span style="color:#FFFFFF">Developed By ....... 	<a href="http://www.phptpoint.com">ShamolDas</a> </span>
	</div>
    <!-- jQuery -->
