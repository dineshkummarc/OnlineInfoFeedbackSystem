...
?>
	...
	<Tr>
		<Td colspan="2"><?php echo @$err;?></Td>
				...
				<tr>
					<td>Choose Your Occupation</td>
					<Td>
					Farmer<input value="farmer" type="checkbox" name="hob[]"/>
					Business<input value="business" type="checkbox" name="hob[]"/>
					
					Barber<input value="barber" type="checkbox" name="hob[]"/>
					Job<input value="job" type="checkbox" name="hob[]"/>
