	...
	<Tr>
		<Td colspan="2"><?php echo @$err;?></Td>
				...
				<tr>
					...
					Recur<input value="recur" <?php if(in_array("recur",$arrr)){echo "checked";} ?> type="checkbox" name="hob[]"/>
					Dancing<input value="dancing" <?php if(in_array("dancing",$arrr)){echo "checked";} ?> type="checkbox" name="hob[]"/>
					</td>
				</tr>
